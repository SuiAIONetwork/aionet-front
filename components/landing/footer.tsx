...
export function Footer() {
  ...
  return (
    <footer className="bg-black relative overflow-hidden border-t border-white/10" ref={ref}>
      {/* Background elements */}
      ...
      <div className="absolute top-0 right-1/4 w-64 h-64 bg-purple-500/5 rounded-full filter blur-[80px]" />
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        >
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://discord.com" className="text-white/60 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        {/* Bottom Section */}
        <div
          className="pt-8 mt-8 border-t border-white/10 text-white/60 text-sm flex flex-col md:flex-row justify-between items-center"
          style={{
            opacity: inView ? 1 : 0,
            transform: inView ? "translateY(0)" : "translateY(20px)",
            transition: "all 0.7s cubic-bezier(0.17, 0.55, 0.55, 1)",
